...
<style>
    ...
    /* Hero Section */
    .contact-hero {
        background: url('https://images.pexels.com/photos/5908491/pexels-photo-5908491.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2') no-repeat center center/cover;
        height: 70vh;
        display: flex;
